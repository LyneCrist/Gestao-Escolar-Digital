...
SECRET_KEY = "django-insecure-45ia!6rrp7lb@ri=k7ac1102!!^vw$(5)@cg!7wq#(s@_$747j"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Configuração para o Render
PORT = int(os.environ.get("PORT", 8000))  # Render usa a variável de ambiente PORT
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    '.onrender.com',
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "setup.context_processors.global_variables",
            ],
        },
    },
]
